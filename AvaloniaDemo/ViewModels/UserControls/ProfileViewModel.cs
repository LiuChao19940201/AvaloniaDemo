...
public partial class ProfileViewModel : ObservableObject
{
    ...
    [RelayCommand] private void OpenService()   { }
    [RelayCommand] private void OpenFavorites() { }
    [RelayCommand] private void OpenMoments()   { }
    [RelayCommand] private void OpenChannels()  { }
    [RelayCommand] private void OpenOrders()    { }
    [RelayCommand] private void OpenEmoji()     { }
    [RelayCommand] private void OpenSettings()  { }
    [RelayCommand] private void OpenQrCode()    { }
    [RelayCommand] private void AddStatus()     { }
    [RelayCommand] private void OpenFriends()   { }
}
